...
// Profile routes (using JWT-based authentication)
router.get('/profile', sellerAuth, sellerAuthController.getProfileByJWT);
router.put('/profile', sellerAuth, sellerAuthController.updateProfileByJWT);
